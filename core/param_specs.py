...
PARAM_SPECS: dict[str, ParamSpec] = {
    ...
    "pipeline.batch_correction": ParamSpec(
        path="pipeline.batch_correction",
        default="None",
        value_type=str,
        scope="shared-editable",
        gui_visible=True,
        gui_editable=True,
        gui_label="Batch correction",
        gui_tab="normalization",
        gui_control="NormTab.batch_combo",
    ),
    ...
    "pipeline.batch_labels": ParamSpec(
        path="pipeline.batch_labels",
        default=None,
        value_type=(object, type(None)),
        scope="runtime-only",
    ),
    "pipeline.combat_covariates": ParamSpec(
        path="pipeline.combat_covariates",
        default=None,
        value_type=(object, type(None)),
        scope="runtime-only",
    ),
    "pipeline.combat_par_prior": ParamSpec(
        path="pipeline.combat_par_prior",
        default=True,
        value_type=bool,
        scope="runtime-only",
    ),
    "pipeline.combat_mean_only": ParamSpec(
        path="pipeline.combat_mean_only",
        default=False,
        value_type=bool,
        scope="runtime-only",
    ),
    "pipeline.combat_ref_batch": ParamSpec(
        path="pipeline.combat_ref_batch",
        default=None,
        value_type=(str, type(None)),
        scope="runtime-only",
    ),
    "pipeline.combat_source": ParamSpec(
        path="pipeline.combat_source",
        default=None,
        value_type=(str, type(None)),
        scope="runtime-only",
    ),
    "combat.covariate_mode": ParamSpec(
        path="combat.covariate_mode",
        default="labels",
        value_type=str,
        scope="shared-editable",
        gui_visible=True,
        gui_editable=True,
        gui_label="ComBat covariate mode",
        gui_tab="normalization",
        gui_control="NormTab.combat_mode_combo",
    ),
    "combat.sample_info_covariates": ParamSpec(
        path="combat.sample_info_covariates",
        default_factory=_empty_list,
        value_type=list,
        scope="shared-editable",
        gui_visible=True,
        gui_editable=True,
        gui_label="ComBat SampleInfo covariates",
        gui_tab="normalization",
        gui_control="NormTab.combat_covariate_list",
    ),
    "combat.mean_only": ParamSpec(
        path="combat.mean_only",
        default=False,
        value_type=bool,
        scope="shared-editable",
        gui_visible=True,
        gui_editable=True,
        gui_label="ComBat mean-only",
        gui_tab="normalization",
        gui_control="NormTab.combat_mean_only_check",
    ),
    "combat.par_prior": ParamSpec(
        path="combat.par_prior",
        default=True,
        value_type=bool,
        scope="shared-editable",
        gui_visible=True,
        gui_editable=True,
        gui_label="ComBat parametric prior",
        gui_tab="normalization",
        gui_control="NormTab.combat_par_prior_check",
    ),
    "combat.ref_batch": ParamSpec(
        path="combat.ref_batch",
        default=None,
        value_type=(str, type(None)),
        scope="shared-editable",
        gui_visible=True,
        gui_editable=True,
        gui_label="ComBat reference batch",
        gui_tab="normalization",
        gui_control="NormTab.combat_ref_batch_combo",
    ),
...
PIPELINE_RUNTIME_KEYS: frozenset[str] = frozenset(
    {
        "factors",
        "factor_source",
        "batch_labels",
